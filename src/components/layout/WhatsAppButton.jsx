...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // Show after 1.5s — quick enough to be useful
      ...
      {visible && (
        ...
        >
          ...
          <motion.span
            ...
            className="font-inter text-xs bg-white text-navy px-3 py-1.5 rounded-sm shadow-lg"
